...
import { TeacherProfileResponse } from "../types/api/teaching-profile";
...
export const useGetTeachingProfile = (
  staffId: string,
  options?: Partial<
    UseQueryOptions<TeacherProfileResponse, ServerErrorResponse>
  >
) => {
  return useQuery<TeacherProfileResponse, ServerErrorResponse>({
