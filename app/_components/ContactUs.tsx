...
const ContactUs = () => {
  ...
  return (
    <section id="contact-us" className="mx-4 sm:mx-8 md:mx-16 lg:mx-20 xl:mx-25 mt-8 md:mt-15 lg:mt-25 xl:lg:mt-33.75 mb-29.25 lg:mb-31.75">
  ...
  {/* left / blue panel */}
  <div className="w-full rounded-tl-lg rounded-tr-lg bg-primary p-4 py-8 sm:rounded-tr-none sm:rounded-tl-[48px] sm:rounded-bl-[48px] sm:p-12">
  ...
  {/* right / white panel */}
  <div className="flex w-full items-center rounded-bl-lg rounded-br-lg bg-[#F3F3F3] px-4 py-8 sm:rounded-bl-none sm:rounded-tr-[48px] sm:rounded-br-[48px] sm:px-12 sm:py-24">
      ...
      <div className="flex w-full flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex h-12 w-full items-center rounded-[8px] border border-[#D0D5DD] bg-white shadow-[0px_1px_2px_0px_#1018280D]">
            {/* country dropdown */}
            <div className="relative flex h-12 w-21 shrink-0 items-center">
              <select
